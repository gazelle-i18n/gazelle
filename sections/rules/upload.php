...
<!-- Actual Uploading Rules -->	
	...
	<div class="box pad" style="padding:10px 10px 10px 20px;">
		<ul>
			...
			<li id="r2.3.12"><a href="#h2.3"><strong>&uarr;_</strong></a> <a href="#r2.3.12">2.3.12.</a> <strong>Properly tag your music files.</strong> Certain meta tags (e.g. ID3, Vorbis) are required on all music uploads. Make sure to use the proper format tags for your files (e.g. no ID3 tags for FLAC). ID3v2 tags for files are highly recommended over ID3v1. If you upload an album missing one or more of these tags, then another user may add the tags, re-upload, and report yours for deletion. The required tags are:
				<ul>
